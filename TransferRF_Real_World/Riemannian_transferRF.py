...
def main(problem_config):
    ...
    number_of_data_RF_training = 30000
    number_of_data_RF_test = 30000
    number_of_data_TL_training = 10
    max_number_of_data_TL_training = 30000
    number_of_data_TL_test = 30000
    
    result_path = f'Result/{problem_selection}/Result_TransferRF_final/{problem_origin}to{problem_target}'
    ...
    for k in range(1, number_of_repetition+1):
        ...
        # We generate the datasets accordingly. e.g. kinematics_robot_arm
        X_RF_training, Y_RF_training, X_RF_test, Y_RF_test, X_TL_training, Y_TL_training, \
            X_TL_test, Y_TL_test, TL_training_data = generate_data_kinematics_robot_arm_all_training_transfer(problem_selection,
    ...
    print("The Original RFR Model on transfer learning test data: ")
    ...
    print("The transferred RFR Model on transfer learning test data: ")
...
if __name__ == '__main__':
    BBOB_function_list = ['Real_World_kinematics_robot_arm_full_training_transfer']
    output_vars = ['Torque1', 'Torque2', 'Torque3', 'Torque4', 'Torque5', 'Torque6', 'Torque7']
    problem_configs = [(fn, src, trg) for fn in BBOB_function_list for src in output_vars for trg in output_vars if src != trg]
    num_cpu = 42
    with Pool(num_cpu) as pool:
        results = pool.map(main, problem_configs)